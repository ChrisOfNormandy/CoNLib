...
public class ModDimension extends DimensionType {
    public ModDimension(OptionalLong p_i241973_1_, boolean p_i241973_2_, boolean p_i241973_3_, boolean p_i241973_4_,
        ...
        super(p_i241973_1_, p_i241973_2_, p_i241973_3_, p_i241973_4_, p_i241973_5_, p_i241973_6_, p_i241973_8_,
                p_i241973_9_, p_i241973_10_, p_i241973_11_, p_i241973_12_, p_i241973_13_, p_i241973_14_, p_i241973_15_,
                p_i241973_16_, p_i241973_17_);
    }
    ...
    public static SimpleRegistry<Dimension> dimensions(Registry<Biome> biomeRegistry,
        ...
        registry.register(Dimension.NETHER, new Dimension(() -> DEFAULT_NETHER,
                defaultNetherGenerator(biomeRegistry, dimensionSettingsRegistry, seed)), Lifecycle.stable());

        registry.register(Dimension.END,
                new Dimension(() -> DEFAULT_END, defaultEndGenerator(biomeRegistry, dimensionSettingsRegistry, seed)),
                Lifecycle.stable());
