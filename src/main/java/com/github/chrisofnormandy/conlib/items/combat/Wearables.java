...
public class Wearables {
    ...
    public static final ArmorItem create(String name, Type armorType) {
        return create(name, new Properties(), armorType, ArmorMaterials.CHAIN);
    }

    public static final ArmorItem create(String name, Type armorType, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, new Properties(), armorType, ArmorMaterials.CHAIN, creativeTab);
    }

    public static final ArmorItem create(String name, Type armorType, ArmorMaterial armorMaterial) {
    ...
    public static final ArmorItem create(String name, Properties properties, Type armorType) {
    ...
    public static final ArmorItem create(String name, Properties properties, Type armorType,
        ...
        ArmorItem item = ItemRegistry.register(name, new ArmorItem(armorMaterial, armorType, properties));
    ...
    public static final ArmorItem create(String name, Properties properties, Type armorType,
        ...
        ArmorItem item = ItemRegistry.register(name, new ArmorItem(armorMaterial, armorType, properties), creativeTab);
        ModRegister.wearable.put(name, item);
