...
public class Eggs {
    ...
    public static final <T extends Animal> RegistryObject<Egg<T>> create(String name) {
    ...
    public static final <T extends Animal> RegistryObject<Egg<T>> create(String name, Properties properties) {
