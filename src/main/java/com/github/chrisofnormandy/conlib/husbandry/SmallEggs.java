...
public class SmallEggs {
    ...
    public static final <T extends Animal> SmallEgg<T> create(String name) {
        return create(name, Properties.copy(Blocks.TURTLE_EGG));
    }

    public static final <T extends Animal> SmallEgg<T> create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.TURTLE_EGG), creativeTab);
    }

    public static final <T extends Animal> SmallEgg<T> create(String name, Properties properties) {
