...
public class Fires {
    ...
    public static final FireBlock create(String name) {
        return create(name, Properties.copy(Blocks.FIRE));
    }

    public static final FireBlock create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.FIRE), creativeTab);
    }

    public static final FireBlock create(String name, Properties properties) {
