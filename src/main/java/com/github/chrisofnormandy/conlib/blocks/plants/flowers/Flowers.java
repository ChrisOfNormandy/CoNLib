...
public class Flowers {
    ...
    public static final RegistryObject<CustomFlower> create(String name) {
        return create(name, Properties.copy(Blocks.POPPY), MobEffects.HEAL, 0);
    }

    public static final RegistryObject<CustomFlower> create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.POPPY), MobEffects.HEAL, 0, creativeTab);
    }

    public static final RegistryObject<CustomFlower> create(String name, Properties properties) {
