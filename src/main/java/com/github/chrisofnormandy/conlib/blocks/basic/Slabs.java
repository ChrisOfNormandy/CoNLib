...
public class Slabs {
    ...
    public static final RegistryObject<SlabBlock> create(String name) {
        return create(name, Properties.copy(Blocks.SMOOTH_STONE_SLAB));
    }

    public static final RegistryObject<SlabBlock> create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.SMOOTH_STONE_SLAB), creativeTab);
    }

    public static final RegistryObject<SlabBlock> create(String name, Block sourceBlock) {
    ...
    public static final RegistryObject<SlabBlock> create(String name, Properties properties) {
