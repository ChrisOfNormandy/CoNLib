...
public class Doors {
    ...
    public static final RegistryObject<DoorBlock> create(String name) {
        return create(name, Blocks.OAK_DOOR, BlockSetType.OAK);
    }

    public static final RegistryObject<DoorBlock> create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Blocks.OAK_DOOR, BlockSetType.OAK, creativeTab);
    }

    public static final RegistryObject<DoorBlock> create(String name, Properties properties) {
    ...
    public static final RegistryObject<DoorBlock> create(String name, BlockSetType blockSetType) {
    ...
    public static final RegistryObject<DoorBlock> create(String name, Block sourceBlock) {
    ...
    public static final RegistryObject<DoorBlock> create(String name, Block sourceBlock, BlockSetType blockSetType) {
    ...
    public static final RegistryObject<DoorBlock> create(String name, Properties properties, BlockSetType blockSetType,
            ResourceKey<CreativeModeTab> creativeTab) {
