...
public class Rails {
    ...
    public static final RegistryObject<RailBlock> create(String name) {
        return create(name, Properties.copy(Blocks.RAIL));
    }

    public static final RegistryObject<RailBlock> create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.RAIL), creativeTab);
    }

    public static final RegistryObject<RailBlock> create(String name, Properties properties) {
