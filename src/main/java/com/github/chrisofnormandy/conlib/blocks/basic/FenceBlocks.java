...
public class FenceBlocks {
    ...
    public static final RegistryObject<FenceBlock> create(String name) {
        return create(name, Properties.copy(Blocks.OAK_FENCE));
    }

    public static final RegistryObject<FenceBlock> create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.OAK_FENCE), creativeTab);
    }

    public static final RegistryObject<FenceBlock> create(String name, Block sourceBlock) {
    ...
    public static final RegistryObject<FenceBlock> create(String name, Properties properties) {
