...
public class WallBlocks {
    ...
    public static final WallBlock create(String name) {
        return create(name, Properties.copy(Blocks.COBBLESTONE_WALL));
    }

    public static final WallBlock create(String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(Blocks.COBBLESTONE_WALL), creativeTab);
    }

    public static final WallBlock create(String name, Block sourceBlock) {
        return create(name, Properties.copy(sourceBlock));
    }

    public static final WallBlock create(String name, Block sourceBlock, ResourceKey<CreativeModeTab> creativeTab) {
        return create(name, Properties.copy(sourceBlock), creativeTab);
    }

    public static final WallBlock create(String name, Properties properties) {
